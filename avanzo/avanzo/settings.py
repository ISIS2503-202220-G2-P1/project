...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'avanzo', 'templates', 'avanzo')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "https://isis2503-zejiran.us.auth0.com/v2/logout?returnTo=http%3A%2F%2F34.160.146.119"
